...
using EventHorizon.Basic.Bot.Socket.Cookie;

namespace EventHorizon.Basic.Bot.Socket
{
    public static class WebSocketClientWrapper
    {
        /// <summary>
        ...
        public static async Task ConnectAsync(
            ...
            Action<WebSocketWrapper> onConnect, 
            bool reconnectOnError = false,
            bool reconnectOnClose = false, 
            int secondsBetweenReconnect = 0, 
            Action<ClientWebSocketOptions> setOptions = null
        )
        {
